...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0"><span class="text-muted fw-light">Inventario /</span> Insumos</h4>
                        ...
                        <?php if (!empty($insumos)): ?>
                            <?php foreach ($insumos as $insumo): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($insumo['descripcion'] ?? 'Sin descripción'); ?></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="agregarInsumoForm" action="./agregarInsumo" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="cantidad_insumo" name="cantidad_insumo"
                                    min="0" required>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            onclick="submitAgregarInsumoForm()">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
