    ...
    <div class="authentication-inner py-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <h4 class="mb-2">¿Ha olvidado tu contraseña? 🔒</h4>
          <p class="mb-4">Introduce tu correo electrónico y te enviaremos instrucciones para restablecer tu contraseña</p>
          <form id="formAuthentication" class="mb-3" action="./solicitarRestablecimiento" method="POST">
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary d-grid w-100">Enviar enlace de restablecimiento</button>
          </form>
