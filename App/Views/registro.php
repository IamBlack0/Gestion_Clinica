        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Bienvenido estimado cliente</h4>
                    <p class="mb-4">Únete a nuestra clínica AHORA🚀</p>

                    <form id="formAuthentication" class="mb-3" action="./registro" method="POST"
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="terms-conditions">
                                    Acepto la
                                    <a href="#">política de privacidad y términos</a>
                                </label>
                            </div>
                        </div>
